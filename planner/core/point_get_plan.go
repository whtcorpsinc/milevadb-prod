...
// IsSelectForUFIDelateLockType checks if the select lock type is for uFIDelate type.
...
func getLockWaitTime(ctx stochastikctx.Context, lockInfo *ast.SelectLockInfo) (lock bool, waitTime int64) {
	if lockInfo != nil {
