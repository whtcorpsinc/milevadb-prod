...
func (pn *planEncoder) encodePlan(p Plan, isRoot bool, causetstore ekv.StoreType, depth int) {
	...
	case *PhysicalBlockReader:
		pn.encodePlan(copPlan.blockPlan, false, copPlan.StoreType, depth)
	case *PhysicalIndexReader:
		pn.encodePlan(copPlan.indexPlan, false, causetstore, depth)
	case *PhysicalIndexLookUpReader:
		pn.encodePlan(copPlan.indexPlan, false, causetstore, depth)
		pn.encodePlan(copPlan.blockPlan, false, causetstore, depth)
