...
// checkAndInitBlockPriv checks if block scope privilege entry exists in allegrosql.Blocks_priv.
// If unexists, insert a new one.
...
// composeBlockPrivUFIDelateForGrant composes uFIDelate stmt assignment list for block scope privilege uFIDelate.
...
// getBlockPriv gets current block scope privilege set from allegrosql.Blocks_priv.
