...
// hashContext keeps the needed hash context of a EDB causet in hash join.
...
// hashEventContainer handles the rows and the hash map of a causet.
...
// key of hash causet: hash value of key defCausumns
// value of hash causet: EventPtr of the corresponded event
...
// Len returns number of records in the hash causet.
...
// concurrentMapHashBlock is a concurrent hash causet built on concurrentMap
