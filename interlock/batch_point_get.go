...
func (e *BatchPointGetInterDirc) buildVirtualDeferredCausetInfo() {
...
func (e *BatchPointGetInterDirc) Open(context.Context) error {
...
func (e *BatchPointGetInterDirc) Close() error {
...
func (e *BatchPointGetInterDirc) Next(ctx context.Context, req *chunk.Chunk) error {
	req.Reset()
	...
	for !req.IsFull() && e.index < len(e.values) {
		...
		err := DecodeEventValToChunk(e.base().ctx, e.schemaReplicant, e.tblInfo, handle, val, req, e.rowCausetDecoder)
		if err != nil {
			return err
		}
		e.index++
...
func (e *BatchPointGetInterDirc) initialize(ctx context.Context) error {
