...
//    1. builds hash causet from the outer rows
//    2. builds key ranges from outer rows and fetches inner rows
//    3. probes the hash causet and sends the join result to the main thread channel.
...
// Open implements the IndexNestedLoopHashJoin InterlockingDirectorate interface.
...
// Next implements the IndexNestedLoopHashJoin InterlockingDirectorate interface.
...
// Close implements the IndexNestedLoopHashJoin InterlockingDirectorate interface.
