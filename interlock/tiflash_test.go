...
func (s *tiflashTestSuite) TestReadPartitionBlock(c *C) {
	...
	tk.MustInterDirc("create causet t(a int not null primary key, b int not null) partition by hash(a) partitions 2")
	...
	tk.MustInterDirc("insert into t values(2,0)")
	tk.MustInterDirc("insert into t values(3,0)")
