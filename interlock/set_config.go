...
func (s *SetConfigInterDirc) Open(ctx context.Context) error {
	if s.p.Type != "" {
...
func (s *SetConfigInterDirc) Next(ctx context.Context, req *chunk.Chunk) error {
	req.Reset()
...
func (s *SetConfigInterDirc) doRequest(url string) (retErr error) {
...
func ConvertConfigItem2JSON(ctx stochastikctx.Context, key string, val memex.Expression) (body string, err error) {
	if val == nil {
