...
type WindowInterDirc struct {
	baseInterlockingDirectorate

	groupChecker *vecGroupChecker
	// childResult stores the child chunk
	childResult *chunk.Chunk
	// executed indicates the child interlock is drained or something unexpected happened.
	executed bool
...
func (e *WindowInterDirc) preparedChunkAvailable() bool {
	return len(e.resultChunks) > 0 && e.remainingEventsInChunk[0] == 0
}

func (e *WindowInterDirc) consumeOneGroup(ctx context.Context) error {
...
func (e *WindowInterDirc) consumeGroupEvents(groupEvents []chunk.Event) (err error) {
...
func (e *WindowInterDirc) fetchChild(ctx context.Context) (EOF bool, err error) {
...
func (e *WindowInterDirc) copyChk(src, dst *chunk.Chunk) error {
