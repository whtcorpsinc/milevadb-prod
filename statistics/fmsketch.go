...
func (s *FMSketch) InsertValue(sc *stmtctx.StatementContext, value types.Causet) error {
...
func buildFMSketch(sc *stmtctx.StatementContext, values []types.Causet, maxSize int) (*FMSketch, int64, error) {
...
func FMSketchToProto(s *FMSketch) *fidelpb.FMSketch {
	protoSketch := new(fidelpb.FMSketch)
...
func FMSketchFromProto(protoSketch *fidelpb.FMSketch) *FMSketch {
	sketch := &FMSketch{
