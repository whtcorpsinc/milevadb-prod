...
func NewProjectionImpl(proj *causetcore.PhysicalProjection) *ProjectionImpl {
...
func (impl *ProjectionImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	proj := impl.plan.(*causetcore.PhysicalProjection)
...
func NewShowImpl(show *causetcore.PhysicalShow) *ShowImpl {
...
func NewMilevaDBSelectionImpl(sel *causetcore.PhysicalSelection) *MilevaDBSelectionImpl {
...
func NewEinsteinDBSelectionImpl(sel *causetcore.PhysicalSelection) *EinsteinDBSelectionImpl {
...
func (agg *MilevaDBHashAggImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	hashAgg := agg.plan.(*causetcore.PhysicalHashAgg)
...
func NewMilevaDBHashAggImpl(agg *causetcore.PhysicalHashAgg) *MilevaDBHashAggImpl {
...
func NewEinsteinDBHashAggImpl(agg *causetcore.PhysicalHashAgg) *EinsteinDBHashAggImpl {
...
func NewLimitImpl(limit *causetcore.PhysicalLimit) *LimitImpl {
...
func (impl *MilevaDBTopNImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	topN := impl.plan.(*causetcore.PhysicalTopN)
...
func NewMilevaDBTopNImpl(topN *causetcore.PhysicalTopN) *MilevaDBTopNImpl {
...
func NewEinsteinDBTopNImpl(topN *causetcore.PhysicalTopN) *EinsteinDBTopNImpl {
...
func NewUnionAllImpl(union *causetcore.PhysicalUnionAll) *UnionAllImpl {
...
func (impl *ApplyImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	apply := impl.plan.(*causetcore.PhysicalApply)
...
func (impl *ApplyImpl) GetCostLimit(costLimit float64, children ...memo.Implementation) float64 {
	...
	if len(apply.LeftConditions) > 0 {
		leftCount *= causetcore.SelectionFactor
	}
	return (costLimit - leftCost) / leftCount
}

// NewApplyImpl creates a new ApplyImpl.
func NewApplyImpl(apply *causetcore.PhysicalApply) *ApplyImpl {
...
func NewMaxOneRowImpl(maxOneRow *causetcore.PhysicalMaxOneRow) *MaxOneRowImpl {
...
func NewWindowImpl(window *causetcore.PhysicalWindow) *WindowImpl {
