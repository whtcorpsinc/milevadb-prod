...
func (opt *Optimizer) GetImplementationMemrules(node causetcore.LogicalCauset) []ImplementationMemrule {
...
func (opt *Optimizer) FindBestCauset(sctx stochastikctx.Context, logical causetcore.LogicalCauset) (p causetcore.PhysicalCauset, cost float64, err error) {
...
func (opt *Optimizer) onPhasePreprocessing(sctx stochastikctx.Context, plan causetcore.LogicalCauset) (causetcore.LogicalCauset, error) {
...
func (opt *Optimizer) onPhaseImplementation(sctx stochastikctx.Context, g *memo.Group) (causetcore.PhysicalCauset, float64, error) {
	...
	if impl == nil {
		return nil, 0, causetcore.ErrInternal.GenWithStackByArgs("Can't find a proper physical plan for this query")
	}
