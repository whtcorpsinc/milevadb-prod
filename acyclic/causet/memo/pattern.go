...
func GetOperand(p causetcore.LogicalCauset) Operand {
	switch p.(type) {
	case *causetcore.LogicalApply:
		return OperandApply
	case *causetcore.LogicalJoin:
		return OperandJoin
	case *causetcore.LogicalAggregation:
		return OperanPosetDaggregation
	case *causetcore.LogicalProjection:
		return OperandProjection
	case *causetcore.LogicalSelection:
		return OperandSelection
	case *causetcore.LogicalMaxOneRow:
		return OperandMaxOneRow
	case *causetcore.LogicalBlockDual:
		return OperandBlockDual
	case *causetcore.DataSource:
		return OperandDataSource
	case *causetcore.LogicalUnionScan:
		return OperandUnionScan
	case *causetcore.LogicalUnionAll:
		return OperandUnionAll
	case *causetcore.LogicalSort:
		return OperandSort
	case *causetcore.LogicalTopN:
		return OperandTopN
	case *causetcore.LogicalLock:
		return OperandLock
	case *causetcore.LogicalLimit:
		return OperandLimit
	case *causetcore.EinsteinDBSingleGather:
		return OperandEinsteinDBSingleGather
	case *causetcore.LogicalBlockScan:
		return OperandBlockScan
	case *causetcore.LogicalMemBlock:
		return OperandMemBlockScan
	case *causetcore.LogicalIndexScan:
		return OperandIndexScan
	case *causetcore.LogicalShow:
		return OperandShow
	case *causetcore.LogicalWindow:
