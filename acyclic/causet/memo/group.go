...
func Convert2GroupExpr(node causetcore.LogicalCauset) *GroupExpr {
	e := NewGroupExpr(node)
...
func Convert2Group(node causetcore.LogicalCauset) *Group {
...
func (g *Group) BuildKeyInfo() {
	...
	g.Prop.MaxOneRow = e.ExprNode.MaxOneRow() || causetcore.HasMaxOneRow(e.ExprNode, childMaxOneRow)
}
