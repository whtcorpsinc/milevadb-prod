...
const (
	...
	// DefaultRecordCausetInSlowLog is the default value for whether enable log query plan in the slow log.
	DefaultRecordCausetInSlowLog = 1
...
// InitLogger initializes FIDel's logger.
