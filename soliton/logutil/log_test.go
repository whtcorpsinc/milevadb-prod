...
const (
	...
	// [2020/02/13 15:56:05.385 +08:00] [INFO] [log_test.go:167] ["info message"] ["str key"=val] ["int key"=123]
...
func (s *testLogSuite) TestLoggerKeepOrder(c *C) {
	...
	expectMsg := fmt.Sprintf("log_test.go:%v: [warning] slow-query connectionId=1 costTime=1 database=test allegrosql=select 1 succ=true txnStartTS=1 type=slow-query\n", line+1)
