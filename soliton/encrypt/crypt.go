...
func (rs *randStruct) randomInit(password []byte, length int) {
	...
	//  New (MyALLEGROSQL 3.21+) random generation structure initialization
...
// sqlCrypt use to causetstore initialization results
...
//ALLEGROSQLDecode Function to handle the decode() function
func ALLEGROSQLDecode(str string, password string) (string, error) {
	var sc sqlCrypt
...
// ALLEGROSQLEncode Function to handle the encode() function
func ALLEGROSQLEncode(cryptStr string, password string) (string, error) {
	var sc sqlCrypt
