...
// DeriveKeyMyALLEGROSQL derives the encryption key from a password in MyALLEGROSQL algorithm.
// See https://security.stackexchange.com/questions/4863/allegrosql-aes-encrypt-key-length.
func DeriveKeyMyALLEGROSQL(key []byte, blockSize int) []byte {
