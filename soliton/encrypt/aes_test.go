...
func (s *testEncryptSuite) TestAESEncryptWithECB(c *C) {
	...
	tests := []struct {
		...
		// 128 bits key
		{"whtcorpsinc", "1234567890123456", "697BFE9B3F8C2F289DD82C88C7BC95C4", false},
		{"WHTCORPS INC123", "1234567890123456", "CEC348F4EF5F84D3AA6C4FA184C65766", false},
		// 192 bits key
		{"whtcorpsinc", "123456789012345678901234", "E435438AC6798B4718533096436EC342", false}, // 192 bit
		// negtive cases: invalid key length
		{"whtcorpsinc", "12345678901234567", "", true},
		{"whtcorpsinc", "123456789012345", "", true},
	}
...
func (s *testEncryptSuite) TestAESEncryptWithCBC(c *C) {
	...
	tests := []struct {
		...
		// 128 bits key
		{"whtcorpsinc", "1234567890123456", "1234567890123456", "2ECA0077C5EA5768A0485AA522774792", false},
		{"WHTCORPS INC123", "1234567890123456", "1234567890123456", "042962D340F2F95BCC07B56EAC378D3A", false},
		// 192 bits key
		{"whtcorpsinc", "123456789012345678901234", "1234567890123456", "EDECE05D9FE662E381130F7F19BA67F7", false}, // 192 bit
		// negtive cases: invalid key length
		{"whtcorpsinc", "12345678901234567", "1234567890123456", "", true},
		{"whtcorpsinc", "123456789012345", "1234567890123456", "", true},
	}
...
func (s *testEncryptSuite) TestAESEncryptWithOFB(c *C) {
	...
	tests := []struct {
		...
		// 128 bits key
		{"whtcorpsinc", "1234567890123456", "1234567890123456", "0515A36BBF3DE0", false},
		{"WHTCORPS INC123", "1234567890123456", "1234567890123456", "0515A36BBF3DE0DBE9DD", false},
		// 192 bits key
		{"whtcorpsinc", "123456789012345678901234", "1234567890123456", "45A57592449893", false}, // 192 bit
		// negtive cases: invalid key length
		{"whtcorpsinc", "12345678901234567", "1234567890123456", "", true},
		{"whtcorpsinc", "123456789012345", "1234567890123456", "", true},
	}
...
func (s *testEncryptSuite) TestAESDecryptWithOFB(c *C) {
	...
	tests := []struct {
		...
		// 128 bits key
		{"0515A36BBF3DE0", "1234567890123456", "1234567890123456", "whtcorpsinc", false},
		{"0515A36BBF3DE0DBE9DD", "1234567890123456", "1234567890123456", "WHTCORPS INC123", false},
		// 192 bits key
		{"45A57592449893", "123456789012345678901234", "1234567890123456", "whtcorpsinc", false}, // 192 bit
		// negtive cases: invalid key length
		{"whtcorpsinc", "12345678901234567", "1234567890123456", "", true},
		{"whtcorpsinc", "123456789012345", "1234567890123456", "", true},
	}
...
func (s *testEncryptSuite) TestDeriveKeyMyALLEGROSQL(c *C) {
	defer testleak.AfterTest(c)()

	p := []byte("MyALLEGROSQL=insecure! MyALLEGROSQL=insecure! ")
	p = DeriveKeyMyALLEGROSQL(p, 16)
