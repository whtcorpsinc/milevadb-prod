...
type generalCIDefCauslator struct {
}
...
func (gc *generalCIDefCauslator) Compare(a, b string) int {
...
func (gc *generalCIDefCauslator) Key(str string) []byte {
...
func (gc *generalCIDefCauslator) Pattern() WildcardPattern {
	return &ciPattern{}
}
