...
// handleCopAnalyzeRequest handles interlock analyze request.
func handleCopAnalyzeRequest(dbReader *dbreader.DBReader, req *interlock.Request) *interlock.Response {
