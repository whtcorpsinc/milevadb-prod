...
var wholeTaskTypes = []TaskType{CopSingleReadTaskType, CoFIDeloubleReadTaskType, RootTaskType}
...
func NewPhysicalProperty(taskTp TaskType, defcaus []*memex.DeferredCauset, desc bool, expectCnt float64, enforced bool) *PhysicalProperty {
...
func ItemsFromDefCauss(defcaus []*memex.DeferredCauset, desc bool) []Item {
...
func (p *PhysicalProperty) AllDefCaussFromSchema(schemaReplicant *memex.Schema) bool {
...
func (p *PhysicalProperty) GetAllPossibleChildTaskTypes() []TaskType {
	...
	// TODO: For CopSingleReadTaskType and CoFIDeloubleReadTaskType, this function should never be called
...
// required property for children plan in `exhaustPhysicalCausets`, so we don't copy `Enforced` field
