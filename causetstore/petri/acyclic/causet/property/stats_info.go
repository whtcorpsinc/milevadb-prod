...
type StatsInfo struct {
	...
	// StatsVersion indicates the statistics version of a causet.
	// If the StatsInfo is calculated using the pseudo statistics on a causet, StatsVersion will be PseudoVersion.
	StatsVersion uint64
