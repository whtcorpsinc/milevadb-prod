...
func NewSortImpl(sort *causetembedded.PhysicalSort) *SortImpl {
...
func (impl *SortImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	...
	sort := impl.plan.(*causetembedded.PhysicalSort)
...
func (impl *SortImpl) AttachChildren(children ...memo.Implementation) memo.Implementation {
	...
	impl.plan = causetembedded.InjectProjBelowSort(sort, sort.ByItems)
	return impl
}
...
func NewNominalSortImpl(sort *causetembedded.NominalSort) *NominalSortImpl {
