...
func NewBlockDualImpl(dual *causetembedded.PhysicalBlockDual) *BlockDualImpl {
...
func NewMemBlockScanImpl(dual *causetembedded.PhysicalMemBlock) *MemBlockScanImpl {
...
func NewBlockReaderImpl(reader *causetembedded.PhysicalBlockReader, hists *statistics.HistDefCausl) *BlockReaderImpl {
...
func (impl *BlockReaderImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	reader := impl.plan.(*causetembedded.PhysicalBlockReader)
...
func NewBlockScanImpl(ts *causetembedded.PhysicalBlockScan, defcaus []*memex.DeferredCauset, hists *statistics.HistDefCausl) *BlockScanImpl {
...
func (impl *BlockScanImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	ts := impl.plan.(*causetembedded.PhysicalBlockScan)
...
func (impl *IndexReaderImpl) GetCostLimit(costLimit float64, children ...memo.Implementation) float64 {
	reader := impl.plan.(*causetembedded.PhysicalIndexReader)
	sessVars := reader.SCtx().GetStochastikVars()
	copIterWorkers := float64(sessVars.DistALLEGROSQLScanConcurrency())
	if math.MaxFloat64/copIterWorkers < costLimit {
		return math.MaxFloat64
...
func NewIndexReaderImpl(reader *causetembedded.PhysicalIndexReader, tblDefCausHists *statistics.HistDefCausl) *IndexReaderImpl {
...
func (impl *IndexScanImpl) CalcCost(outCount float64, children ...memo.Implementation) float64 {
	is := impl.plan.(*causetembedded.PhysicalIndexScan)
...
func NewIndexScanImpl(scan *causetembedded.PhysicalIndexScan, tblDefCausHists *statistics.HistDefCausl) *IndexScanImpl {
