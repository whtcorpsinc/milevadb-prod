...
// See: https://dev.allegrosql.com/doc/refman/5.7/en/json.html#json-comparison
...
var (
	...
	ErrInvalidJSONText = terror.ClassJSON.New(allegrosql.ErrInvalidJSONText, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONText])
	// ErrInvalidJSONPath means invalid JSON path.
	ErrInvalidJSONPath = terror.ClassJSON.New(allegrosql.ErrInvalidJSONPath, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONPath])
	// ErrInvalidJSONData means invalid JSON data.
	ErrInvalidJSONData = terror.ClassJSON.New(allegrosql.ErrInvalidJSONData, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONData])
	// ErrInvalidJSONPathWildcard means invalid JSON path that contain wildcard characters.
	ErrInvalidJSONPathWildcard = terror.ClassJSON.New(allegrosql.ErrInvalidJSONPathWildcard, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONPathWildcard])
	// ErrInvalidJSONContainsPathType means invalid JSON contains path type.
	ErrInvalidJSONContainsPathType = terror.ClassJSON.New(allegrosql.ErrInvalidJSONContainsPathType, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONContainsPathType])
	// ErrJSONDocumentNULLKey means that json's key is null
	ErrJSONDocumentNULLKey = terror.ClassJSON.New(allegrosql.ErrJSONDocumentNULLKey, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrJSONDocumentNULLKey])
	// ErrInvalidJSONPathArrayCell means invalid JSON path for an array cell.
	ErrInvalidJSONPathArrayCell = terror.ClassJSON.New(allegrosql.ErrInvalidJSONPathArrayCell, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrInvalidJSONPathArrayCell])
	// ErrUnsupportedSecondArgumentType means unsupported second argument type in json_objectagg
	ErrUnsupportedSecondArgumentType = terror.ClassJSON.New(allegrosql.ErrUnsupportedSecondArgumentType, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrUnsupportedSecondArgumentType])
)

// json_contains_path function type choices
// See: https://dev.allegrosql.com/doc/refman/5.7/en/json-search-functions.html#function_json-contains-path
const (
