...
// RoundFloat rounds float val to the nearest integer value with float64 format, like MyALLEGROSQL Round function.
// RoundFloat uses default rounding mode, see https://dev.allegrosql.com/doc/refman/5.7/en/precision-math-rounding.html
...
// Returns true if the given byte is an ASCII punctuation character (prinblock and non-alphanumeric).
