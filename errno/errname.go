...
var MyALLEGROSQLErrName = map[uint16]string{
	...
	ErrCantCreateTable:                          "Can't create causet '%-.200s' (errno: %d)",
	...
	ErrCantFindSystemRec:                        "Can't read record in system causet",
	...
	ErrCheckread:                                "Record has changed since last read in causet '%-.192s'",
	ErrDiskFull:                                 "Disk full (%s); waiting for someone to free some space... (errno: %d - %s)",
	ErrDupKey:                                   "Can't write; duplicate key in causet '%-.192s'",
	...
	ErrNotKeyFile:                               "Incorrect key file for causet '%-.200s'; try to repair it",
	ErrOldKeyFile:                               "Old key file for causet '%-.192s'; repair it!",
	...
	ErrBadTable:                                 "Unknown causet '%-.100s'",
	...
	ErrWrongSumSelect:                           "Statement has sum functions and columns in same memex",
	...
	ErrNonuniqTable:                             "Not unique causet/alias: '%-.192s'",
	...
	ErrKeyDeferredCausetDoesNotExits:                    "Key column '%-.192s' doesn't exist in causet",
	ErrBlobUsedAsKey:                            "BLOB column '%-.192s' can't be used in key specification with the used causet type",
	ErrTooBigFieldlength:                        "DeferredCauset length too big for column '%-.192s' (max = %d); use BLOB or TEXT instead",
	ErrWrongAutoKey:                             "Incorrect causet definition; there can be only one auto column and it must be defined as a key",
	...
	ErrNoSuchIndex:                              "Block '%-.192s' has no index like the one used in CREATE INDEX; recreate the causet",
	...
	ErrUFIDelateTableUsed:                          "You can't specify target causet '%-.192s' for uFIDelate in FROM clause",
	ErrNoSuchThread:                             "Unknown thread id: %d",
	ErrKillDenied:                               "You are not tenant of thread %d",
	...
	ErrWrongTableName:                           "Incorrect causet name '%-.100s'",
	...
	ErrUnknownTable:                             "Unknown causet '%-.192s' in %-.32s",
	...
	ErrTableMustHaveDeferredCausets:                     "A causet must have at least 1 column",
	ErrRecordFileFull:                           "The causet '%-.192s' is full",
	...
	ErrTooBigRowsize:                            "Row size too large. The maximum event size for the used causet type, not counting BLOBs, is %d. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs",
	...
	ErrPasswordNoMatch:                          "Can't find any matching event in the user causet",
	...
	ErrCantReopenTable:                          "Can't reopen causet: '%-.192s'",
	...
	ErrTableaccessDenied:                        "%-.128s command denied to user '%-.48s'@'%-.64s' for causet '%-.64s'",
	ErrDeferredCausetaccessDenied:                       "%-.16s command denied to user '%-.48s'@'%-.64s' for column '%-.192s' in causet '%-.192s'",
	...
	ErrNonexistingTableGrant:                    "There is no such grant defined for user '%-.48s' on host '%-.64s' on causet '%-.192s'",
	...
	ErrDelayedCantChangeLock:                    "Delayed insert thread couldn't get requested dagger for causet %-.192s",
	...
	ErrTableCantHandleBlob:                      "The used causet type doesn't support BLOB/TEXT columns",
	ErrTableCantHandleAutoIncrement:             "The used causet type doesn't support AUTOINCREMENT columns",
	ErrDelayedInsertTableLocked:                 "INSERT DELAYED can't be used with causet '%-.192s' because it is locked with LOCK TABLES",
	...
	ErrWrongMrgTable:                            "Unable to open underlying causet which is differently defined or of non-MyISAM type or doesn't exist",
	ErrDupUnique:                                "Can't write, because of unique constraint, to causet '%-.192s'",
	...
	ErrRequiresPrimaryKey:                       "This causet type requires a primary key",
	ErrNoRaidCompiled:                           "This version of MyALLEGROSQL is not compiled with RAID support",
	ErrUFIDelateWithoutKeyInSafeMode:               "You are using safe uFIDelate mode and you tried to uFIDelate a causet without a WHERE that uses a KEY column",
	ErrKeyDoesNotExist:                          "Key '%-.192s' doesn't exist in causet '%-.192s'",
	ErrCheckNoSuchTable:                         "Can't open causet",
	ErrCheckNotImplemented:                      "The storage engine for the causet doesn't support %s",
	...
	ErrDumpNotImplemented:                       "The storage engine for the causet does not support binary causet dump",
	ErrIndexRebuild:                             "Failed rebuilding the index of  dumped causet '%-.192s'",
	...
	ErrTransCacheFull:                           "Multi-memex transaction required more than 'maxBinlogCacheSize' bytes of storage; increase this mysqld variable and try again",
	ErrTooManyUserConnections:                   "User %-.64s already has more than 'maxUserConnections' active connections",
	ErrSetConstantsOnly:                         "You may only use constant memexs with SET",
	ErrLockWaitTimeout:                          "Lock wait timeout exceeded; try restarting transaction",
	ErrLockTableFull:                            "The total number of locks exceeds the dagger causet size",
	...
	ErrUnionTablesInDifferentDir:                "Incorrect causet definition; all MERGE blocks must be in the same database",
	ErrLockDeadlock:                             "Deadlock found when trying to get dagger; try restarting transaction",
	ErrTableCantHandleFt:                        "The used causet type doesn't support FULLTEXT indexes",
	...
	ErrErrorWhenInterDircutingCommand:                "Error when executing command %s: %-.128s",
	ErrWrongUsage:                               "Incorrect usage of %s and %s",
	ErrWrongNumberOfDeferredCausetsInSelect:             "The used SELECT memexs have a different number of columns",
	...
	ErrDupArgument:                              "Option '%s' used twice in memex",
	...
	ErrKeyRefDoNotMatchTableRef:                 "Key reference and causet reference don't match",
	ErrOperandDeferredCausets:                           "Operand should contain %d column(s)",
	ErrSubqueryNo1Row:                           "Subquery returns more than 1 event",
	ErrUnknownStmtHandler:                       "Unknown prepared memex handler (%.*s) given to %s",
	...
	ErrDerivedMustHaveAlias:                     "Every derived causet must have its own alias",
	...
	ErrWarnUsingOtherHandler:                    "Using storage engine %s for causet '%s'",
	...
	ErrNonUFIDelablockTable:                        "The target causet %-.100s of the %s is not uFIDelablock",
	ErrFeatureDisabled:                          "The '%s' feature is disabled; you need MyALLEGROSQL built with '%s' to have it working",
	ErrOptionPreventsStatement:                  "The MyALLEGROSQL server is running with the %s option so it cannot execute this memex",
	...
	ErrTooMuchAutoTimestampDefCauss:                 "Incorrect causet definition; there can be only one TIMESTAMP column with CURRENTTIMESTAMP in DEFAULT or ON UFIDelATE clause",
	ErrInvalidOnUFIDelate:                          "Invalid ON UFIDelATE clause for '%-.192s' column",
	ErrUnsupportedPs:                            "This command is not supported in the prepared memex protocol yet",
	...
	ErrSpBadmemex:                           "%s is not allowed in stored procedures",
	...
	ErrSpBadCursorQuery:                         "Cursor memex must be a SELECT",
	...
	ErrSpCaseNotFound:                           "Case not found for CASE memex",
	ErrFBerolinaSQLTooBigFile:                        "Configuration file '%-.192s' is too big",
	ErrFBerolinaSQLBadHeader:                         "Malformed file type header in file '%-.192s'",
	ErrFBerolinaSQLEOFInComment:                      "Unexpected end of file while parsing comment '%-.200s'",
	ErrFBerolinaSQLErrorInParameter:                  "Error while parsing parameter '%-.192s' (line: '%-.192s')",
	ErrFBerolinaSQLEOFInUnknownParameter:             "Unexpected end of file while skipping unknown parameter '%-.192s'",
	ErrViewNoExplain:                            "EXPLAIN/SHOW can not be issued; lacking privileges for underlying causet",
	...
	ErrViewSelectTmpblock:                       "View's SELECT refers to a temporary causet '%-.192s'",
	...
	ErrWarnViewWithoutKey:                       "View being uFIDelated does not have complete key of underlying causet in it",
	ErrViewInvalid:                              "View '%-.192s.%-.192s' references invalid causet(s) or column(s) or function(s) or definer/invoker of view lack rights to use them",
	...
	ErrTrgOnViewOrTempTable:                     "Trigger's '%-.192s' is view or temporary causet",
	...
	ErrPsManyParam:                              "Prepared memex contains too many placeholders",
	ErrKeyPart0:                                 "Key part '%-.192s' length cannot be 0",
	ErrViewChecksum:                             "View text checksum failed",
	ErrViewMultiuFIDelate:                          "Can not modify more than one base causet through a join view '%-.192s.%-.192s'",
	...
	ErrSFIDelupHandler:                             "Duplicate handler declared in the same causet",
	...
	ErrInterDircStmtWithOpenCursor:                   "You can't execute a prepared memex which has an open cursor associated with it. Reset the memex to re-execute it.",
	ErrStmtHasNoOpenCursor:                      "The memex (%d) has no open cursor.",
	ErrCommitNotAllowedInSfOrTrg:                "Explicit or implicit commit is not allowed in stored function or trigger.",
	ErrNoDefaultForViewField:                    "Field of view '%-.192s.%-.192s' underlying causet doesn't have a default value",
	...
	ErrForeignDataStringInvalidCantCreate:       "Can't create federated causet. The data source connection string '%-.64s' is not in the correct format",
	ErrForeignDataStringInvalid:                 "The data source connection string '%-.64s' is not in the correct format",
	ErrCantCreateFederatedTable:                 "Can't create federated causet. Foreign data src :  %-.64s",
	...
	ErrCantUFIDelateUsedTableInSfOrTrg:             "Can't uFIDelate causet '%-.192s' in stored function/trigger because it is already used by memex which invoked this stored function/trigger.",
	ErrViewPreventUFIDelate:                        "The definition of causet '%-.192s' prevents operation %.192s on causet '%-.192s'.",
	ErrPsNoRecursion:                            "The prepared memex contains a stored routine call that refers to that same memex. It's not allowed to execute a prepared memex in such a recursive manner",
	...
	ErrViewFrmNoUser:                            "View '%-.192s'.'%-.192s' has no definer information (old causet format). Current user is used as definer. Please recreate the view!",
	...
	ErrSpProcTableCorrupt:                       "Failed to load routine %-.192s. The causet allegrosql.proc is missing, corrupt, or contains bad data (internal code %d)",
	...
	ErrMaxPreparedStmtCountReached:              "Can't create more than maxPreparedStmtCount memexs (current value: %d)",
	ErrViewRecursive:                            "`%-.192s`.`%-.192s` contains view recursion",
	ErrNonGroupingFieldUsed:                     "Non-grouping field '%-.192s' is used in %-.64s clause",
	ErrTableCantHandleSpkeys:                    "The used causet type doesn't support SPATIAL indexes",
	...
	ErrNonInserblockTable:                       "The target causet %-.100s of the %s is not inserblock-into",
	...
	ErrWrongExprInPartitionFunc:                 "Constant, random or timezone-dependent memexs in (sub)partitioning function are not allowed",
	ErrNoConstExprInRangeOrList:                 "Expression in RANGE/LIST VALUES must be constant",
	ErrFieldNotFoundPart:                        "Field in list of fields for partition function not found in causet",
	...
	ErrUniqueKeyNeedAllFieldsInPf:               "A %-.192s must include all columns in the causet's partitioning function",
	ErrNoParts:                                  "Number of %-.64s = 0 is not an allowed value",
	ErrPartitionMgmtOnNonpartitioned:            "Partition management on a not partitioned causet is not possible",
	...
	ErrEventInterDircTimeInThePast:                   "Event execution time is in the past. Event has been disabled",
	ErrEventOpenTableFailed:                     "Failed to open allegrosql.event",
	ErrEventNeitherMExprNorMAt:                  "No datetime memex provided",
	ErrObsoleteDefCausCountDoesntMatchCorrupted:     "DeferredCauset count of allegrosql.%s is wrong. Expected %d, found %d. The causet is probably corrupted",
	ErrObsoleteCannotLoadFromTable:              "Cannot load from allegrosql.%s. The causet is probably corrupted",
	...
	ErrCantWriteLockLogTable:                    "You can't write-dagger a log causet. Only read access is possible",
	ErrCantLockLogTable:                         "You can't use locks with log blocks.",
	ErrForeignDuplicateKeyOldUnused:             "Upholding foreign key constraints for causet '%.192s', entry '%-.192s', key %d would lead to a duplicate entry",
	...
	ErrPartitionNoTemporary:                     "Cannot create temporary causet with partitions",
	...
	ErrEventRecursionForbidden:                  "Recursion of EVENT DBS memexs is forbidden when body is present",
	...
	ErrBadLogStatement:                          "You cannot '%s' a log causet if logging is enabled",
	ErrCantRenameLogTable:                       "Cannot rename '%s'. When logging enabled, rename to/from log causet must rename two blocks: the log causet to an archive causet and another causet back to '%s'",
	...
	ErrBinlogUnsafeStatement:                    "Unsafe memex written to the binary log using memex format since BINLOGFORMAT = STATEMENT. %s",
	...
	ErrTrgCorruptedFile:                         "Corrupted TRG file for causet `%-.64s`.`%-.64s`",
	ErrTrgNoCreationCtx:                         "Triggers for causet `%-.64s`.`%-.64s` have no creation context",
	ErrTrgInvalidCreationCtx:                    "Trigger creation context of causet `%-.64s`.`%-.64s` is invalid",
	ErrEventInvalidCreationCtx:                  "Creation context of event `%-.64s`.`%-.64s` is invalid",
	ErrTrgCantOpenTable:                         "Cannot open causet for trigger `%-.64s`.`%-.64s`",
	ErrCantCreateSroutine:                       "Cannot create stored routine `%-.64s`. Check warnings",
	ErrNoFormatDescriptionEventBeforeBinlogStatement:         "The BINLOG memex of type `%s` was not preceded by a format description BINLOG memex.",
	...
	ErrNeedReprepare:                                         "Prepared memex needs to be re-prepared",
	ErrDelayedNotSupported:                                   "DELAYED option not supported for causet '%-.192s'",
	...
	ErrWarnEngineTransactionRollback:                         "CausetStorage engine %s does not support rollback for this memex. Transaction rolled back and must be restarted",
	ErrNdbReplicationSchema:                                  "Bad schemaReplicant for allegrosql.ndbReplication causet. Message: %-.64s",
	ErrConflictFnParse:                                       "Error in parsing conflict function. Message: %-.64s",
	ErrExceptionsWrite:                                       "Write to exceptions causet failed. Message: %-.128s\"",
	ErrTooLongTableComment:                                   "Comment for causet '%-.64s' is too long (max = %d)",
	...
	ErrRowSinglePartitionField:                               "Row memexs in VALUES IN only allowed for multi-field column partitioning",
	...
	ErrBinlogRowEngineAndStmtEngine:                          "Cannot execute memex: impossible to write to binary log since both event-incapable engines and memex-incapable engines are involved.",
	ErrBinlogRowModeAndStmtEngine:                            "Cannot execute memex: impossible to write to binary log since BINLOGFORMAT = ROW and at least one causet uses a storage engine limited to memex-based logging.",
	ErrBinlogUnsafeAndStmtEngine:                             "Cannot execute memex: impossible to write to binary log since memex is unsafe, storage engine is limited to memex-based logging, and BINLOGFORMAT = MIXED. %s",
	ErrBinlogRowInjectionAndStmtEngine:                       "Cannot execute memex: impossible to write to binary log since memex is in event format and at least one causet uses a storage engine limited to memex-based logging.",
	ErrBinlogStmtModeAndRowEngine:                            "Cannot execute memex: impossible to write to binary log since BINLOGFORMAT = STATEMENT and at least one causet uses a storage engine limited to event-based logging.%s",
	ErrBinlogRowInjectionAndStmtMode:                         "Cannot execute memex: impossible to write to binary log since memex is in event format and BINLOGFORMAT = STATEMENT.",
	ErrBinlogMultipleEnginesAndSelfLoggingEngine:             "Cannot execute memex: impossible to write to binary log since more than one engine is involved and at least one engine is self-logging.",
	ErrBinlogUnsafeLimit:                                     "The memex is unsafe because it uses a LIMIT clause. This is unsafe because the set of rows included cannot be predicted.",
	ErrBinlogUnsafeInsertDelayed:                             "The memex is unsafe because it uses INSERT DELAYED. This is unsafe because the times when rows are inserted cannot be predicted.",
	...
	ErrBinlogUnsafeNontransAfterTrans:                        "Statement is unsafe because it accesses a non-transactional causet after accessing a transactional causet within the same transaction.",
	...
	ErrWrongNativeTableStructure:                             "Native causet '%-.64s'.'%-.64s' has the wrong structure",
	ErrWrongPerfSchemaUsage:                                  "Invalid performanceSchema usage.",
	ErrWarnISSkippedTable:                                    "Block '%s'.'%s' was skipped since its definition is being modified by concurrent DBS memex",
	...
	ErrBinlogUnsafeMultipleEnginesAndSelfLoggingEngine:       "Mixing self-logging and non-self-logging engines in a memex is unsafe.",
	ErrBinlogUnsafeMixedStatement:                            "Statement accesses nontransactional causet as well as transactional or temporary causet, and writes to any of them.",
	...
	ErrTruncateIllegalFk:                                     "Cannot truncate a causet referenced in a foreign key constraint (%.192s)",
	ErrPluginIsPermanent:                                     "Plugin '%s' is forcePlusPermanent and can not be unloaded",
	ErrStmtCacheFull:                                         "Multi-event memexs required more than 'maxBinlogStmtCacheSize' bytes of storage; increase this mysqld variable and try again",
	ErrMultiUFIDelateKeyConflict:                                "Primary key/partition key uFIDelate is not allowed since the causet is uFIDelated both as '%-.192s' and '%-.192s'.",
	...
	ErrBinlogUnsafeInsertTwoKeys:                             "INSERT... ON DUPLICATE KEY UFIDelATE  on a causet with more than one UNIQUE KEY is unsafe",
	...
	ErrCannotLoadFromTableV2:                                 "Cannot load from %s.%s. The causet is probably corrupted",
	ErrOnlyFdAndRbrEventsAllowedInBinlogStatement:            "Only FormatDescriptionLogEvent and event events are allowed in BINLOG memexs (but %s was provided)",
	ErrPartitionExchangeDifferentOption:                      "Non matching attribute '%-.64s' between partition and causet",
	...
	ErrPartitionInsteadOfSubpartition:                        "Subpartitioned causet, use subpartition instead of partition",
	ErrUnknownPartition:                                      "Unknown partition '%-.64s' in causet '%-.64s'",
	...
	ErrNoSuchKeyValue:                                        "Key value '%-.192s' was not found in causet '%-.192s.%-.192s'",
	...
	ErrCantUFIDelateTableInCreateTableSelect:                    "Can't uFIDelate causet '%-.192s' while '%-.192s' is being created.",
	ErrPartitionClauseOnNonpartitioned:                       "PARTITION () clause on non partitioned causet",
	...
	ErrMtsUFIDelatedDBsGreaterMax:                               "The number of modified databases exceeds the maximum %d; the database names will not be included in the replication event spacetimedata.",
	...
	ErrForeignDuplicateKeyWithChildInfo:                      "Foreign key constraint for causet '%.192s', record '%-.192s' would lead to a duplicate entry in causet '%.192s', key '%.192s'",
	ErrForeignDuplicateKeyWithoutChildInfo:                   "Foreign key constraint for causet '%.192s', record '%-.192s' would lead to a duplicate entry in a child causet",
	ErrTableHasNoFt:                                          "The causet does not have FULLTEXT index to support this query",
	...
	ErrSetStatementCannotInvokeFunction:                      "The memex 'SET %.200s' cannot invoke a stored function.",
	...
	ErrCantDoImplicitCommitInTrxWhenGtidNextIsSet:            "Cannot execute memexs with implicit commit inside a transaction when @@SESSION.GTIDNEXT != AUTOMATIC or @@SESSION.GTIDNEXTLIST != NULL.",
	...
	ErrGtidUnsafeNonTransactionalTable:                       "When @@GLOBAL.ENFORCEGTIDCONSISTENCY = 1, uFIDelates to non-transactional blocks can only be done in either autocommitted memexs or single-memex transactions, and never in the same memex as uFIDelates to transactional blocks.",
	ErrGtidUnsafeCreateSelect:                                "CREATE TABLE ... SELECT is forbidden when @@GLOBAL.ENFORCEGTIDCONSISTENCY = 1.",
	ErrGtidUnsafeCreateDropTemporaryTableInTransaction:       "When @@GLOBAL.ENFORCEGTIDCONSISTENCY = 1, the memexs CREATE TEMPORARY TABLE and DROP TEMPORARY TABLE can be executed in a non-transactional context only, and require that AUTOCOMMIT = 1.",
	...
	ErrCantSetGtidNextWhenOwningGtid:                         "@@SESSION.GTIDNEXT cannot be changed by a client that owns a GTID. The client owns %s. Tenantship is released on COMMIT or ROLLBACK.",
	ErrUnknownExplainFormat:                                  "Unknown EXPLAIN format name: '%s'",
	ErrCantInterDircuteInReadOnlyTransaction:                      "Cannot execute memex in a READ ONLY transaction.",
	ErrTooLongTablePartitionComment:                          "Comment for causet partition '%-.64s' is too long (max = %d)",
	ErrInnodbFtLimit:                                         "InnoDB presently supports one FULLTEXT index creation at a time",
	ErrInnodbNoFtTempTable:                                   "Cannot create FULLTEXT index on temporary InnoDB causet",
	...
	ErrDefCausCountDoesntMatchCorruptedV2:                        "DeferredCauset count of %s.%s is wrong. Expected %d, found %d. The causet is probably corrupted",
	ErrDiscardFkChecksRunning:                                "There is a foreign key check running on causet '%-.192s'. Cannot discard the causet.",
	...
	ErrTablespaceMissing:                                     "Tablespace is missing for causet '%-.192s'",
	ErrTablespaceExists:                                      "Tablespace for causet '%-.192s' exists. Please DISCARD the blockspace before IMPORT.",
	ErrTablespaceDiscarded:                                   "Tablespace has been discarded for causet '%-.192s'",
	...
	ErrMustChangePassword:                                    "You must SET PASSWORD before executing this memex",
	ErrFkNoIndexChild:                                        "Failed to add the foreign key constaint. Missing index for constraint '%s' in the foreign causet '%s'",
	ErrFkNoIndexParent:                                       "Failed to add the foreign key constaint. Missing index for constraint '%s' in the referenced causet '%s'",
	ErrFkFailAddSystem:                                       "Failed to add the foreign key constraint '%s' to system blocks",
	ErrFkCannotOpenParent:                                    "Failed to open the referenced causet '%s'",
	ErrFkIncorrectOption:                                     "Failed to add the foreign key constraint on causet '%s'. Incorrect options in FOREIGN KEY constraint '%s'",
	...
	ErrFkDeferredCausetCannotDropChild:                               "Cannot drop column '%-.192s': needed in a foreign key constraint '%-.192s' of causet '%-.192s'",
	ErrFkDeferredCausetNotNull:                                       "DeferredCauset '%-.192s' cannot be NOT NULL: needed in a foreign key constraint '%-.192s' SET NULL",
	ErrDupIndex:                                              "Duplicate index '%-.64s' defined on the causet '%-.64s.%-.64s'. This is deprecated and will be disallowed in a future release.",
	ErrFkDeferredCausetCannotChange:                                  "Cannot change column '%-.192s': used in a foreign key constraint '%-.192s'",
	ErrFkDeferredCausetCannotChangeChild:                             "Cannot change column '%-.192s': used in a foreign key constraint '%-.192s' of causet '%-.192s'",
	ErrFkCannotDeleteParent:                                  "Cannot delete rows from causet which is parent in a foreign key constraint '%-.192s' of causet '%-.192s'",
	...
	ErrCantSetGtidPurgedWhenGtidInterDircutedIsNotEmpty:           "@@GLOBAL.GTIDPURGED can only be set when @@GLOBAL.GTIDEXECUTED is empty.",
	...
	ErrGtidInterDircutedWasChanged:                                "@@GLOBAL.GTIDEXECUTED was changed from '%s' to '%s'.",
	ErrBinlogStmtModeAndNoReplTables:                         "Cannot execute memex: impossible to write to binary log since BINLOGFORMAT = STATEMENT, and both replicated and non replicated blocks are written to.",
	...
	ErrAlterOperationNotSupportedReasonCopy:                  "COPY algorithm requires a dagger",
	...
	ErrBadGeneratedDeferredCauset:                                    "The value specified for generated column '%s' in causet '%s' is not allowed.",
	...
	ErrInvalidJSONPath:                                       "Invalid JSON path memex %s.",
	ErrInvalidTypeForJSON:                                    "Invalid data type for JSON data in argument %d to function %s; a JSON string or JSON type is required.",
	ErrInvalidJSONPathWildcard:                               "In this situation, path memexs may not contain the * and ** tokens.",
	...
	ErrInvalidJSONPathArrayCell:                              "A path memex is not a path to a cell in an array.",
	...
	ErrWindowRangeFrameOrderType:                             "Window '%s' with RANGE N PRECEDING/FOLLOWING frame requires exactly one ORDER BY memex, of numeric or temporal type",
	ErrWindowRangeFrameTemporalType:                          "Window '%s' with RANGE frame has ORDER BY memex of datetime type. Only INTERVAL bound value allowed.",
	ErrWindowRangeFrameNumericType:                           "Window '%s' with RANGE frame has ORDER BY memex of numeric type, INTERVAL bound value not allowed.",
	ErrWindowRangeBoundNotConstant:                           "Window '%s' has a non-constant frame bound.",
	ErrWindowDuplicateName:                                   "Window '%s' is defined twice.",
	ErrWindowIllegalOrderBy:                                  "Window '%s': ORDER BY or PARTITION BY uses legacy position indication which is not supported, use memex.",
	ErrWindowInvalidWindowFuncUse:                            "You cannot use the window function '%s' in this context.'",
	ErrWindowInvalidWindowFuncAliasUse:                       "You cannot use the alias '%s' of an memex containing a window function in this context.'",
	...
	ErrMaxInterDircTimeExceeded:                                   "Query execution was interrupted, max_execution_time exceeded.",
	...
	ErrFunctionalIndexOnLob:                                  "Cannot create a functional index on an memex that returns a BLOB or TEXT. Please consider using CAST",
	...
	ErrWrongKeyDeferredCausetFunctionalIndex:                         "The used storage engine cannot index the memex '%s'",
	...
	ErrWrongInsertIntoSequence:              "Wrong INSERT into a SEQUENCE. One can only do single causet INSERT into a sequence object (like with mysqldump).  If you want to change the SEQUENCE, use ALTER SEQUENCE instead.",
	ErrSequenceInvalidTableStructure:        "Sequence '%-.64s.%-.64s' causet structure is invalid (%s)",

	// MilevaDB errors.
	ErrMemExceedThreshold:         "%s holds %EDB memory, exceeds threshold %EDB.%s",
	ErrForUFIDelateCantRetry:         "[%d] can not retry select for uFIDelate memex",
	ErrAdminCheckTable:            "MilevaDB admin check causet failed.",
	...
	ErrSchemaReplicantChanged:          "Information schemaReplicant is changed during the execution of the memex(for example, causet definition may be uFIDelated by other DBS ran in parallel). If you see this error often, try increasing `milevadb_max_delta_schema_count`",
	...
	ErrTableStateCantNone:         "causet %s can't be in none state",
	...
	ErrNotTenant:                   "MilevaDB server is not a DBS tenant",
	...
	ErrRepairTable:                "Failed to repair causet: %s",
	ErrLoadPrivilege:              "Load privilege causet fail: %s",
	...
	ErrCantGetValidID:             "Cannot get a valid auto-ID when retrying the memex",
	...
	ErrInvalidListMetaData:        "invalid list spacetime data",
	...
	ErrSequenceUnsupportedTableOption:      "Unsupported sequence causet-option %s",
	...
	ErrAnalyzeMissIndex:                    "Index '%s' in field list does not exist in causet '%s'",
	ErrCartesianProductUnsupported:         "Cartesian product is unsupported",
	ErrPreparedStmtNotFound:                "Prepared memex not found",
	ErrWrongParamCount:                     "Wrong parameter count",
	ErrSchemaChanged:                       "Schema has changed",
	ErrUnknownCauset:                         "Unknown plan",
	ErrPrepareMulti:                        "Can not prepare multiple memexs",
	ErrPrepareDBS:                          "Can not prepare DBS memexs with parameters",
	ErrResultIsEmpty:                       "Result is empty",
	ErrBuildInterlockingDirectorate:                       "Failed to build interlock",
	ErrBatchInsertFail:                     "Batch insert failed, please clean the causet and try again.",
	...
	ErrInvalidWildCard:                     "Wildcard fields without any causet name appears in wrong place",
	ErrMixOfGroupFuncAndFieldsIncompatible: "In aggregated query without GROUP BY, memex #%d of SELECT list contains nonaggregated column '%s'; this is incompatible with sql_mode=only_full_group_by",
	...
	ErrTableOptionUnionUnsupported:         "CREATE/ALTER causet with union option is not supported",
	ErrTableOptionInsertMethodUnsupported:  "CREATE/ALTER causet with insert method option is not supported",
