...
var MyALLEGROSQLErrName = map[uint16]string{
	...
	ErrTableNotLockedForWrite:                   "Block '%-.192s' was locked with a READ lock and can't be uFIDelated",
	...
	ErrDelayedCantChangeLock:                    "Delayed insert thread couldn't get requested lock for block %-.192s",
	...
	ErrLockTableFull:                            "The total number of locks exceeds the lock block size",
	ErrReadOnlyTransaction:                      "UFIDelate locks cannot be acquired during a READ UNCOMMITTED transaction",
	ErrDroFIDelBWithReadLock:                       "DROP DATABASE not allowed while thread is holding global read lock",
	...
	ErrCantUFIDelateWithReadlock:                   "Can't execute the query because you have a conflicting read lock",
	...
	ErrWrongLockOfSystemTable:                   "You can't combine write-locking of system blocks with other blocks or lock types",
	...
	ErrCantWriteLockLogTable:                    "You can't write-lock a log block. Only read access is possible",
