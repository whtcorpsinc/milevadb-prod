...
const (
	...
	// CoercibilityIgnorable is derived from NULL or an memex that is derived from NULL.
...
// DeriveDefCauslationFromExprs derives defCauslation information from these memexs.
