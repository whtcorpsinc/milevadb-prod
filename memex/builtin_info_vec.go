...
func (b *builtinMilevaDBIsDBSTenantSig) vectorized() bool {
	return true
}

func (b *builtinMilevaDBIsDBSTenantSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
