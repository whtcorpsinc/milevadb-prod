...
// Clone copies the total schemaReplicant.
...
// ExprFromSchema checks if all defCausumns of this memex are from the same schemaReplicant.
...
// RetrieveDeferredCauset retrieves defCausumn in memex from the defCausumns in schemaReplicant.
