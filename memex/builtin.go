...
// spacetimedata returns the spacetimedata of a function.
// spacetimedata means some functions contain extra inner fields which will not
// contain in `fidelpb.Expr.children` but must be pushed down to interlock
func (b *baseBuiltinFunc) spacetimedata() proto.Message {
...
// spacetimedata returns the spacetimedata of cast functions
func (b *baseBuiltinCastFunc) spacetimedata() proto.Message {
...
// reverseBuiltinFunc evaluates the exactly one defCausumn value in the function when given a result for memex.
...
type builtinFunc interface {
	...
	// getArgs returns the arguments memexs.
	getArgs() []Expression
...
// check memex/function_traits.go to see if it should be appended to
// any set there.
var funcs = map[string]functionClass{
	...
	ast.MilevaDBIsDBSTenant: &milevadbIsDBSTenantFunctionClass{baseFunctionClass{ast.MilevaDBIsDBSTenant, 0, 0}},
	ast.MilevaDBParseTso:   &milevadbParseTsoFunctionClass{baseFunctionClass{ast.MilevaDBParseTso, 1, 1}},
	ast.MilevaDBDecodeCauset: &milevadbDecodeCausetFunctionClass{baseFunctionClass{ast.MilevaDBDecodeCauset, 1, 1}},
