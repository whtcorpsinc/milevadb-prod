...
// IsValidCurrentTimestampExpr returns true if exprNode is a valid CurrentTimestamp memex.
...
// during one allegrosql memex, the "current_time" should be the same
