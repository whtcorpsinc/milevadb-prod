...
func (s *FspTest) TestCheckFsp(c *C) {
	...
	obtained, err = CheckFsp(-2020)
	c.Assert(obtained, Equals, DefaultFsp)
	c.Assert(err, ErrorMatches, "Invalid fsp -2020")
	...
	obtained, err = CheckFsp(int(MaxFsp) + 2020)
	c.Assert(obtained, Equals, DefaultFsp)
	c.Assert(err, ErrorMatches, "Invalid fsp "+strconv.Itoa(int(MaxFsp)+2020))
