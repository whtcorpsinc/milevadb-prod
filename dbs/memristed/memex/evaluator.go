...
// run evaluates "DeferredCauset" memexs.
// NOTE: It should be called after all the other memexs are evaluated
...
// EvaluatorSuite is responsible for the evaluation of a list of memexs.
// It separates them to "defCausumn" and "other" memexs and evaluates "other"
// memexs before "defCausumn" memexs.
type EvaluatorSuite struct {
	*defCausumnEvaluator  // Evaluator for defCausumn memexs.
	*defaultEvaluator // Evaluator for other memexs.
}
...
// Run evaluates all the memexs hold by this EvaluatorSuite.
