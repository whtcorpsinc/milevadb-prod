...
func (b *builtinConvertSig) evalString(event chunk.Event) (string, bool, error) {
	...
	target, _, err := transform.String(encoding.NewCausetDecoder(), expr)
...
// Quote produce a result that can be used as a properly escaped data value in an ALLEGROALLEGROSQL memex.
