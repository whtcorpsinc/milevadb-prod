...
// SupportReverseEval returns if this memex supports reversed evaluation.
...
func typeInferForNull(args []Expression) {
	...
	for _, arg := range args {
		...
		// Break if there are both NULL and non-NULL memex
...
// SetCoercibility sets a specified coercibility for this memex.
