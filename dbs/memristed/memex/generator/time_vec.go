...
func generateDotGo(fileName string) error {
	w := new(bytes.Buffer)
	err := addOrSubTime.InterDircute(w, function{FuncName: "AddTime", Sigs: addTimeSigsTmpl})
	if err != nil {
		return err
	}
	err = addOrSubTime.InterDircute(w, function{FuncName: "SubTime", Sigs: subTimeSigsTmpl})
	if err != nil {
		return err
	}
	err = timeDiff.InterDircute(w, timeDiffSigsTmpl)
	if err != nil {
		return err
	}
	err = addOrSubDate.InterDircute(w, function{FuncName: "AddDate", Sigs: addDataSigsTmpl})
	if err != nil {
		return err
	}
	err = addOrSubDate.InterDircute(w, function{FuncName: "SubDate", Sigs: subDataSigsTmpl})
	if err != nil {
		return err
	}
