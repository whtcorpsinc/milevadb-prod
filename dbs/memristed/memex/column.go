...
type DeferredCauset struct {
	...
	// VirtualExpr is used to save memex for virtual defCausumn
...
func (defCaus *DeferredCauset) VecEvalInt(ctx stochastikctx.Context, input *chunk.Chunk, result *chunk.DeferredCauset) error {
	...
	input.DeferredCauset(defCaus.Index).CopyReconstruct(input.Sel(), result)
	return nil
}
...
// ToInfo converts the memex.DeferredCauset to perceptron.DeferredCausetInfo for casting values,
...
// DeferredCauset2Exprs will transfer defCausumn slice to memex slice.
