...
// Vectorizable checks whether a list of memexs can employ vectorized execution.
...
// HasGetSetVarFunc checks whether an memex contains SetVar/GetVar function.
...
// HasAssignSetVarFunc checks whether an memex contains SetVar function and assign a value
...
// VectorizedInterDircute evaluates a list of memexs defCausumn by defCausumn and append their results to "output" Chunk.
func VectorizedInterDircute(ctx stochastikctx.Context, exprs []Expression, iterator *chunk.Iterator4Chunk, output *chunk.Chunk) error {
